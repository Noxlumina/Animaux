...
public class Main {
    public static void main(String[] args) {
        ...
        MartinPecheur martinPecheur=new MartinPecheur("Flipper",new Date(2011, Calendar.MARCH, 10),15.0);
        ...
        aquarium.setAquatiqueList(martinPecheur);
        voliere.setVolatileList(martinPecheur);
